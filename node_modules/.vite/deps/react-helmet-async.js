...
// node_modules/.pnpm/react-helmet-async@3.0.0_react@18.3.1/node_modules/react-helmet-async/lib/index.esm.js
...
var HelmetProvider = (_a = class extends Component {
  ...
  render() {
    if (isReact19) {
      return React3.createElement(React3.Fragment, null, this.props.children);
    }
    return React3.createElement(Context.Provider, { value: this.helmetData.value }, this.props.children);
  }
...
var _a2;
var Helmet = (_a2 = class extends Component4 {
  shouldComponentUpdate(nextProps) {
  ...
  render() {
    ...
    if (isReact19) {
      return React5.createElement(React19Dispatcher, { ...newProps });
    }
    return helmetData ? React5.createElement(HelmetDispatcher, { ...newProps, context: helmetData.value }) : React5.createElement(Context.Consumer, null, (context) => React5.createElement(HelmetDispatcher, { ...newProps, context }));
  }
