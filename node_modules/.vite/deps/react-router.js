...
function ErrorWrapper({
  ...
  return React32.createElement("html", { lang: "en" }, React32.createElement("head", null, React32.createElement("meta", { charSet: "utf-8" }), React32.createElement(
    "meta",
    {
      name: "viewport",
      content: "width=device-width,initial-scale=1,viewport-fit=cover"
    }
  ), React32.createElement("title", null, title)), React32.createElement("body", null, React32.createElement("main", { style: { fontFamily: "system-ui, sans-serif", padding: "2rem" } }, children)));
}
function RSCDefaultRootErrorBoundaryImpl({
  ...
  console.error(error);
  let heyDeveloper = React32.createElement(
    "script",
    {
      dangerouslySetInnerHTML: {
        __html: `
  ...
  if (isRouteErrorResponse(error)) {
    return React32.createElement(
      ...
      React32.createElement("h1", { style: { fontSize: "24px" } }, error.status, " ", error.statusText),
  ...
  return React32.createElement(ErrorWrapper, { renderAppShell, title: "Application Error!" }, React32.createElement("h1", { style: { fontSize: "24px" } }, "Application Error"), React32.createElement(
    "pre",
    {
      style: {
        padding: "2rem",
